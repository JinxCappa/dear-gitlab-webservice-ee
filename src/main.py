...
def main():
    ...
    for gitlab_version in gitlab_versions:
        if gitlab_version not in github_tags and gitlab_version not in ["16.5.5", "16.6.3", "16.7.1", "17.1.5", "17.2.3", "17.2.6", "17.7.5", "17.8.3"] and int(gitlab_version.split('.')[0]) > 12:
